...
// Trust proxy is strictly required for Vercel to see the correct client IPs
...
// 1. Global Rate Limiter: Protects all routes from general spam
...
// 2. Strict AI Rate Limiter: Protects your Gemini API wallet specifically
...
// Chat endpoint (with the strict AI rate limiter applied)
app.post('/api/v1/trace/chat', chatLimiter, async (req, res) => {
